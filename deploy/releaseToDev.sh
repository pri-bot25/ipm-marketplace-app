...
sed -i "s/  host: ipm-pivot-stage/  host: $temp_inst/g" deploy/manifest-dev.yml
sed -i "s/- name: ipm-pivot-stage/- name: $temp_inst/g" deploy/manifest-dev.yml
...
if [ $errorCode == 0 ]; then
        ...
        echo "Blue-green deployment for ipm-pivot-dev app successful."
else
