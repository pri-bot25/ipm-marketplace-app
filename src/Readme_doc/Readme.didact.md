...
=======
>>>>>>> f9f1cae2bac768a327adfdc6afd2d46204df9012
...
<li>In <span class="tag is-light is-normal">API Subscriptions</span> section launch <span class="tag is-light is-normal">IBM Marketplace APIs</span> , If you are not able to see <span class="tag is-light is-normal ">IBM Marketplace APIs</span><br>then click on <span class="tag is-light is-normal">Visit IBM API Hub</span> and search for IBM Marketplace APIs and subscribe.</li>
<li>After launching <span class="tag is-light is-normal">IBM Marketplace APIs</span> , you will see <span class="tag is-light is-normal">Key management</span> section where your existing API Key's will be listed.</li><br>

<li>If no key's listed then use <span class="tag is-light is-normal">Generate API Key</span> button and create new key.</li><br>

<li>Copy the <span class="tag is-light is-normal">Client ID</span> and <span class="tag is-light is-normal">Client secret</span> by expanding the key from the list.</li>
</ol>
<br><br>
...
<li>Clone the new sample app by clicking the "Clone the app" button. </li><br>

<a class="button is-dark is-medium" title="Clone the app" href='didact://?commandId=vscode.didact.sendNamedTerminalAString&text=nodejs%20terminal%201$$cd%20%2Fprojects%20%26%26%20git%20clone%20-b%20playground%20https%3A%2F%2Fgithub.ibm.com%2Fdigital-marketplace%2Fipm-pivot.git' >Clone the App</a>
<br><br>
...
![3PM Punchout Approach](src/Readme_doc/Punchout_16.gif){.imageCenter}
...
![ipmConfigID](src/Readme_doc/3PM_Code1.png){.imageCenter}
...
![3PM Embed](src/Readme_doc/Embed_16.gif){.imageCenter}
...
![3PM Appendix](src/Readme_doc/3PM_Appendix.png){.imageCenter}
